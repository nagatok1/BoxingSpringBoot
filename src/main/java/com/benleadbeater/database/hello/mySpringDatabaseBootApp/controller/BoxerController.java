...
import com.benleadbeater.database.hello.mySpringDatabaseBootApp.repository.BoxerRepository;
...
public class BoxerController {
	...
	public BoxerModel getBoxerbyID(@PathVariable(value = "id") Long id) {
		return myRepository.findById(id)
				.orElseThrow(() -> new ResourceNotFoundException("boxingSpringBoot", "id", id));
	}
